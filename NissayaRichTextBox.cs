...
namespace NissayaEditor
{
    public partial class Form1 : Form
    {
        ...
        public partial class NissayaTabPage
        {
            ...
            public string GetThisTabPageKey(string pgNo = "") 
            { 
                return this.FileName + "-P" + ((pgNo.Length > 0) ? pgNo : this.curFindPgNo); 
            }
...
*/
            ...
            public bool HandleMenuShortCuts(object sender, KeyEventArgs e)
            {
                ...
                // load new file
                //if (e.Control && e.KeyCode == Keys.O && !e.Handled)
                //{
                ...
                // Ctrl-3 = #
                if ((e.Control) && e.KeyCode == Keys.D3) //  || e.Shift removed
                {
                    e.Handled = true;
                    KeyDownHandled = true;
                    richTextBox1_InsertText(sender, "#");
